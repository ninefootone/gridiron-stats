...
export default function GamePage() {
  ...
  return (
    ...
    <nav className={styles.bottomNav}>
        ...
        {!isViewer && (
          <button className={styles.bottomNavItem} onClick={openStatFirst}>
            <svg className={styles.bottomNavIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAdmin && (
          <button className={styles.bottomNavItem} onClick={() => { setAdjustForm({ team: 'ours', adjustment: '', reason: '' }); setAdjustModal(true); }}>
            <svg className={styles.bottomNavIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
