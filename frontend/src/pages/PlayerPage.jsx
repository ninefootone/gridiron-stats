  ...
  return (
    <div>
      ...
      {teamRole === 'admin' && (
        <div style={{ marginBottom: 24, display: 'flex', justifyContent: 'flex-end' }}>
          <button className="btn btn-secondary btn-sm" onClick={() => {
            ...
            doc.text('Generated by Gridiron Stats · gridiron-stats.app', 14, doc.internal.pageSize.getHeight() - 10);
      ...
      <nav className={styles.bottomNav}>
        <button className={styles.bottomNavItem} onClick={() => navigate(`/teams/${teamId}?tab=players`)}>
        ...
        <button className={styles.bottomNavItem} onClick={() => navigate(`/teams/${teamId}?tab=games`)}>
          <svg className={styles.bottomNavIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAdmin && (
          <button className={styles.bottomNavItem} onClick={() => navigate(`/teams/${teamId}?tab=plays`)}>
            <svg className={styles.bottomNavIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button className={styles.bottomNavItem} onClick={() => navigate(`/teams/${teamId}?tab=leaderboard`)}>
          <svg className={styles.bottomNavIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAdmin && (
          <button className={styles.bottomNavItem} onClick={() => navigate(`/teams/${teamId}?tab=members`)}>
            <svg className={styles.bottomNavIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
