  ...
  return (
    <div>
      ...
      <nav className="bottom-nav">
        <button className="bottom-nav-item" onClick={() => navigate(`/teams/${teamId}?tab=players`)}>
        ...
        <button className="bottom-nav-item" onClick={() => navigate(`/teams/${teamId}?tab=games`)}>
          <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAdmin && (
          <button className="bottom-nav-item" onClick={() => navigate(`/teams/${teamId}?tab=plays`)}>
            <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button className="bottom-nav-item" onClick={() => navigate(`/teams/${teamId}?tab=leaderboard`)}>
          <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAdmin && (
          <button className="bottom-nav-item" onClick={() => navigate(`/teams/${teamId}?tab=members`)}>
            <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
