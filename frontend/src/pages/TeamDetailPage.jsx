  ...
  return (
    <div>
      ...
      <nav className="bottom-nav">
        <button className={`bottom-nav-item ${tab === 'players' ? 'bottom-nav-active' : ''}`} onClick={() => setTab('players')}>
        ...
        <button className={`bottom-nav-item ${tab === 'games' ? 'bottom-nav-active' : ''}`} onClick={() => setTab('games')}>
          <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
	...
	{isAdmin && (
          <button className={`bottom-nav-item ${tab === 'plays' ? 'bottom-nav-active' : ''}`} onClick={() => { setTab('plays'); loadPlays(); }}>
            <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button className={`bottom-nav-item ${tab === 'leaderboard' ? 'bottom-nav-active' : ''}`} onClick={() => setTab('leaderboard')}>
          <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAdmin && (
          <button className={`bottom-nav-item ${tab === 'members' ? 'bottom-nav-active' : ''}`} onClick={() => { setTab('members'); loadMembers(); }}>
            <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
